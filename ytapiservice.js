module.exports = {
    index: function(callback) {
        ...
        fs.readFile('client_secret.json', function processClientSecrets(err, content) {
            ...
            //console.log(JSON.parse(content), {'params': {'mine': 'true', 'part': 'snippet', 'fields' : 'items/snippet/resourceId/channelId,nextPageToken,pageInfo,prevPageToken,tokenPagination', 'maxResults' : '50'}});
        ...
        function subscriptionsListMySubscriptions(auth, requestData) {
            ...
            service.subscriptions.list(parameters, function(err, response) {
                ...
                return callback(channelList);

                // Use this to debug response json
                // var obj = response;
                // console.log(
